...
const LoadingUI = ({ duration = 3500, onComplete }) => {
    ...
    const interval = setInterval(() => {
      setProgress(prev => {
        if (prev >= 100) {
          ...
          setTimeout(() => { setIsLoading(false); onComplete?.(); }, 400);
          return 100;
        }
            ...
            <div style={{ border: '3px solid #001A6E', background: '#FFFFFF', boxShadow: '6px 6px 0px #0055FF' }}>
              ...
              <div className="p-8">
                ...
                <div className="w-full h-6 bg-white relative overflow-hidden"
                  ...
                  />
                  {/* Scan line */}
                  <div className="absolute inset-y-0 w-0.5" style={{ left: `${progress}%`, background: '#001A6E' }} />
                </div>
